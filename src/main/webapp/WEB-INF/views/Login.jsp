...
<h3>Register here..</h3>
<form>
<button type="submit" formaction="index.jsp" class="btn btn-primary">Register</button>
</form>
    <div class = "container">
        ...
        <div class="row">
            ...
            <div class="col-lg-4">
                    ...
                    <form class="form" action="auth">
          
                    <h5 class="display-5" align="center">Please Sign in</h5>
